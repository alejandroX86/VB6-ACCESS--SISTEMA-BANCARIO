...
Begin VB.Form FRMCON2 
   ...
   ClientTop       =   450
   ClientWidth     =   14955
   Icon            =   "FRMCON2.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "FRMCON2.frx":57E2
   ScaleHeight     =   9765
   ScaleWidth      =   14955
...
SQL = "SELECT CODEMP AS [CODIGO],EMPLEADO,C.DESCAR AS [CARGO],DIR AS [DIRECCION],TEL AS [TELEFONO],SEXO,D.DISTRITO FROM EMPLEADOS E, CARGOS C, LOCALIDAD D WHERE E.CODDIS=D.CODDIS AND E.CODCAR=C.CODCAR"

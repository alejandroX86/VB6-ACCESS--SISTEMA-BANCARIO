...
Select Case Index
       ...
       Case 5:
          Dim SEX As String
          CODD = BUSCAR("LOCALIDAD", "DISTRITO", CBODIS.Text, 0)
...
CBODIS = BUSCAR("LOCALIDAD", "CODDIS", CODDIS, 1)
End Sub

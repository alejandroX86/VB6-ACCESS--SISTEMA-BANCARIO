...
Begin VB.Form FRMEMP 
   ...
   ClientTop       =   450
   ClientWidth     =   15000
   Icon            =   "FRMEMP.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "FRMEMP.frx":57E2
   ScaleHeight     =   9345
   ScaleWidth      =   15000
...
Select Case CBOBCAR.ListIndex
       ...
       SQLBUS = "SELECT CODEMP,EMPLEADO,DIR,TEL,SEXO,D.DISTRITO FROM EMPLEADOS E, LOCALIDAD D WHERE E.CODDIS=D.CODDIS AND CODCAR='" + CADBUS + "'"
...
Select Case Index
       ...
       CODDIS = BUSCAR("LOCALIDAD", "DISTRITO", CBODIS.Text, 0)
       ...
       Case 4: RS.CancelUpdate
               ...
               CMDCONTROL(5).Enabled = False
       Case 5:
       CDIST = BUSCAR("LOCALIDAD", "DISTRITO", CBODIS.Text, 0)
...
CBODIS = BUSCAR("LOCALIDAD", "CODDIS", CDIST, 1)
End Sub

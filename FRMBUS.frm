...
CBOOB = ""
CBOTC = ""
SQL = "SELECT CODCLI,NOMCLI,DIRCLI,TELCLI,SEXO FROM CLIENTES C,LOCALIDAD D WHERE D.CODDIS=C.CODDIS AND D.DISTRITO='" + CBODIS + "'"

...
SQL = "SELECT CODCLI AS [CODIGO], NOMCLI AS [NOMBRE], DIRCLI AS [DIRECCION], TELCLI AS [TELEFONO], SEXO, D.DISTRITO FROM CLIENTES C, LOCALIDAD D WHERE C.CODDIS=D.CODDIS"
